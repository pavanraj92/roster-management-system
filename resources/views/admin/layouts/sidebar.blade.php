    ...
    <nav>
        <ul class="menu-aside">
            ...
            <li class="menu-item {{ request()->routeIs('admin.shifts.*') ? 'active' : '' }}">
                <a class="menu-link" href="{{ route('admin.shifts.index') }}">
                    <i class="icon material-icons md-schedule"></i>
            ...
            @can('task_access')
            <li class="menu-item {{ request()->routeIs('admin.tasks.*') ? 'active' : '' }}">
                <a class="menu-link" href="{{ route('admin.tasks.index') }}">
                    <i class="icon material-icons md-task_alt"></i>
