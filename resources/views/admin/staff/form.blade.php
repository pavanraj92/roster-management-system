<div class="row g-4 staff-form-grid">
    ...
    <div class="mb-4 col-lg-6">
        ...
        <input type="text" placeholder="Select joining date" name="joining_date" class="form-control datepicker" id="joining_date"
            value="{{ old('joining_date', isset($staff) ? $staff->joining_date : '') }}" autocomplete="off">
