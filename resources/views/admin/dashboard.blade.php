            ...
            <div class="card card-body mb-4">
                <article class="icontext">
                    <span class="icon icon-sm rounded-circle bg-success-light"><i
                            class="text-success material-icons md-person"></i></span>
                    <div class="text">
                        <h6 class="mb-1 card-title">Active Staff</h6>
                        <span>{{ $staffsCount }}</span>
                        <!-- <span class="text-sm"> Registered administrators/staff-member </span> -->
                    </div>
                </article>
            </div>
        </div>
            ...
            <div class="card card-body mb-4">
                <article class="icontext">
                    <span class="icon icon-sm rounded-circle bg-success-light"><i
                            class="text-success material-icons md-person"></i></span>
                    <div class="text">
                        <h6 class="mb-1 card-title">Total Shift</h6>
                        <span>{{ $staffsCount }}</span>
                        <!-- <span class="text-sm"> Registered administrators/staff-member </span> -->
                    </div>
                </article>
        ...
        <div class="col-xl-8 col-lg-12">
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="card mb-4">
                        <article class="card-body">
                            <h5 class="card-title">New Staff Members</h5>
                            <div class="new-member-list">
                                @foreach($latestStaffs as $staff)
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ $staff->image ? asset('storage/' . $staff->image) : asset('backend/imgs/people/avatar-1.png') }}" alt=""
                                            class="avatar" />
                                        <div>
                                            <h6>{{ $staff->name }}</h6>
                                            <p class="text-muted font-xs">{{ $staff->email }}</p>
                                        </div>
                                    </div>
                                    <a href="#" class="btn btn-xs"><i class="material-icons md-add"></i> Details</a>
                                </div>
                                @endforeach
                            </div>
                        </article>
