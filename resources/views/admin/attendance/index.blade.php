    ...
    <div class="row">
        <div class="clearfix">
            <div class="float-start">
                <h2 class="content-title card-title mb-0">Attendance Manager</h2>
                <p class="listing-page-subtitle mb-3">
                    Manage attendance (e.g. Present, Late, Absent).
                </p>
            </div>

            <x-admin.breadcrumb :list="[['label' => 'Attendance Manager']]" class="float-end" />
        </div>
    </div>
        ...
        <header class="card-header">
            <div class="row align-items-center listing-filter-bar">
                ...
                <div class="d-flex flex-wrap align-items-center gap-2">
                    <div class="col-md-2">
                        <input type="text" placeholder="Search attendance..." class="form-control"
                            id="custom-search">
                    </div>
